...
> - Utilisez les liens **Réviser** en début de page et **Approfondir** en fin de page pour naviguer entre notions connexes.
...
* **Entraînement :** Chaque module intègre des liens directs vers des exercices dédiés.
